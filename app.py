...
def main():
    ...
    # print(f'\n Frequency of each Nucleotide: {countfreq(sampledna)}')
    # print(f'\n Trnascription of DNA -> {transcription(sampledna)}')
    # print(f'\n Reverse Transcription: {reversetranscription(sampledna)}\n')
    # print(f" DNA String + Complement + Reverse Complement:\n 5'{sampledna} 3'")
    # print(f"   {''.join(['|' for c in range(len(sampledna))])}")
    # print(f" 3'{reverse_complement(sampledna)[::-1]} 5'[Complement]")
    # print(f" 5'{reverse_complement(sampledna)} 3'[Reverse Complement]")
    # print(f"\n GC Content = {gc_content(sampledna)}%")
